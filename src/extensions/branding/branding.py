...
class Branding(commands.Cog):
    ...
    async def update_status(self) -> None:
        ...
        status_type: str = secrets.choice(status_types)
        status: str = secrets.choice(self.config["status"][status_type])  # pyright: ignore [reportOptionalSubscript, reportUnknownArgumentType]
